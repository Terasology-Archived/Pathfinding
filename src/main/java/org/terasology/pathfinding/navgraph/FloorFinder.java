...
public class FloorFinder {
    ...
    private final Map<Region, Integer> count = Maps.newHashMap();
    private final List<Sweep> sweeps = Lists.newArrayList();
    private final Map<WalkableBlock, Region> regionMap = Maps.newHashMap();
    private final Map<WalkableBlock, Sweep> sweepMap = Maps.newHashMap();
